    ...
    <footer id="footer" class="text-center text-lg-start bg-body">
			<!-- Grid container -->
			<div class="container p-4">
				...
				<div class="row mt-4">
					...
					<div class="col-lg-4 col-md-12 mb-4 mb-md-0">
						<h5 class="text-uppercase mb-4">Over frami</h5>
		
						<p>
						Frami Autosport est. 1960
						<br>
						Officieel importeur van OMP producten.
						<br>
						Voor al uw kart kleding, auto accessoires.
						</p>
		
						<p>
							Bekijk onze social media om op de hoogte te blijven van nieuwe producten. Zo kan je ook zien waar we zijn, op bijvoorbeeld een race weekend. Dan kan je ons gemakkelijk vinden.
						</p>
		
						<div class="mt-4">
							<a class="btn btn-floating btn-primary btn-lg icon">
					...
					<div class="col-lg-4 col-md-6 mb-4 mb-md-0">
						...
						<ul class="fa-ul" style="margin-left: 1.65em;">
							<li class="mb-3">
								...
								<span class="ms-2">Scharnerweg 34, 6224 JH Maastricht</span>
							</li>
							<li class="mb-3">
								...
								<span class="ms-2 codedirection">moc.imarf@mit</span>
							</li>
							<li class="mb-3">
								...
								<span class="ms-2">+31 6 42 11 15 56</span>
							</li>
							<li class="mb-3">
					...
					<!--Grid column-->
					<div class="col-lg-4 col-md-6 mb-4 mb-md-0">
						<h5 class="text-uppercase mb-4">Openings tijden</h5>
